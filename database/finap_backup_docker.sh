...
psql -h napotedb -U napote postgres -c "CREATE USER ote;" || true
psql -h napotedb -U napote postgres -c "CREATE USER flyway;" || true
...
pg_restore -h napotedb -U napote -c -C -f /database/restore.sql /database/finap.dump
...
psql -h napotedb -U napote -f /database/restore.sql napote
