...
psql -h napotedb163 -U napote postgres -c "CREATE USER ote;" || true
psql -h napotedb163 -U napote postgres -c "CREATE USER flyway;" || true
...
psql -h napotedb163 -U napote -f /database/restore.sql napote
