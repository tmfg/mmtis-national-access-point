...
INSERT INTO "transport-service"("id","transport-operator-id","type","terminal","passenger-transportation","rental","parking","brokerage","created","created-by","modified","modified-by","published?","contact-address","contact-phone","contact-gsm","contact-email","homepage","name","ckan-dataset-id","ckan-resource-id","sub-type","companies")
VALUES
