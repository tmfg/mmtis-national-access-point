...
INSERT INTO "public"."transport-service"("transport-operator-id","type","terminal","passenger-transportation","rentals","parking","brokerage","created","created-by","modified","modified-by","published?","contact-address","contact-phone","contact-gsm","contact-email","homepage","name","ckan-dataset-id","ckan-resource-id","sub-type","companies","brokerage?")
VALUES
(1,E'passenger-transportation',NULL,E'({},"(,{})","(,{})",{},"{""(starting,5.9,trip,)"",""(\\\\""basic fare\\\\"",4.9,km,)""}",{},{},{},{},{},"(,{})",{},{},,{},{},{},{},{},{},{},"{""(FI,*FI*)"",""(SV,*SV*)"",""(EN,*EN*)""}",mandatory)',NULL,NULL,NULL,E'2017-12-04 12:51:06.539+00',E'401139db-8f3e-4371-8233-5d51d4c4c8b6',E'2017-12-04 12:57:34.93+00',E'401139db-8f3e-4371-8233-5d51d4c4c8b6',FALSE,E'("Street 1",90100,Oulu)',E'123456',NULL,NULL,E'www.solita.fi',E'Taksi',NULL,NULL,E'taxi',NULL,FALSE);
