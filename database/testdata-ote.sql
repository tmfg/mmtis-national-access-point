...
INSERT INTO "public"."transport-service" ("id", "transport-operator-id", type, terminal, "passenger-transportation",
                                          rentals, parking, brokerage, created, "created-by", modified, "modified-by",
                                          "published?", "contact-address", "contact-phone", "contact-gsm", "contact-email",
                                          homepage, name, "ckan-dataset-id", "ckan-resource-id", "sub-type", companies,
                                          "brokerage?", description, "available-from", "available-to", "notice-external-interfaces?",
                                          "companies-csv-url", "company-source", "company-csv-filename", "transport-type")
VALUES
  (1, 1, E'passenger-transportation', NULL,
      ...
      NULL, NULL, E'{road}'),
  (2, 1, E'passenger-transportation', NULL, E'({},"(,{})","(,{})",{},{},{},{},{},{},{},"(,{})",{},{},,{},{},{},{},{},{},{},{},no)',
      NULL, NULL, NULL, E'2017-12-04 12:51:06.539000', E'401139db-8f3e-4371-8233-5d51d4c4c8b6',
      E'2018-06-11 16:12:50.550000', E'401139db-8f3e-4371-8233-5d51d4c4c8b6', TRUE, E'("Street 1",90100,Oulu)', E'123456', NULL, NULL,
      'www.solita.fi', 'Bussipalvelu', NULL, NULL, 'schedule', NULL, false,  NULL, NULL, NULL, true, NULL,
      NULL, NULL, '{road}');

INSERT INTO "external-interface-description" (id, "transport-service-id", "external-interface", "format", "data-content")
     VALUES (999, 2, '(http://www.notexists123.com.ab/,{})', '{GTFS}', '{route-and-schedule}');
