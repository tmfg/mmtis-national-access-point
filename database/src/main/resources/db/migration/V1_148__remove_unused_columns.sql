-- Remove unused columns ckan-resource-id and ckan-dataset-id
ALTER TABLE "transport-service"
  DROP COLUMN "ckan-resource-id" CASCADE,
  DROP COLUMN "ckan-dataset-id" CASCADE ;


-- Create view again without removed columns
