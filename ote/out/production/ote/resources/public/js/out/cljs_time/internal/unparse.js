...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__41102 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__41102){
return (function (p1__41101_SHARP_){
return cljs.core.subs.call(null,p1__41101_SHARP_,(0),(3));
});})(G__41102))
,G__41102);
} else {
return G__41102;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__41111){
var vec__41112 = p__41111;
var t = cljs.core.nth.call(null,vec__41112,(0),null);
var pattern = cljs.core.nth.call(null,vec__41112,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__41115 = pattern;
switch (G__41115) {
case "S":
...
switch (G__41125__$1) {
case "millis":
return ((function (G__41125,G__41125__$1){
return (function (p1__41117_SHARP_){
return p1__41117_SHARP_.getMilliseconds();
});
;})(G__41125,G__41125__$1))

break;
case "seconds":
return ((function (G__41125,G__41125__$1){
return (function (p1__41118_SHARP_){
return p1__41118_SHARP_.getSeconds();
});
;})(G__41125,G__41125__$1))
...
return p1__41119_SHARP_.getMinutes();
});
;})(G__41125,G__41125__$1))
...
return p1__41120_SHARP_.getHours();
});
;})(G__41125,G__41125__$1))
...
return p1__41121_SHARP_.getHours();
});
;})(G__41125,G__41125__$1))
...
return p1__41122_SHARP_.getDate();
});
;})(G__41125,G__41125__$1))
...
return p1__41123_SHARP_.getMonth();
});
;})(G__41125,G__41125__$1))
...
return p1__41124_SHARP_.getYear();
});
;})(G__41125,G__41125__$1))

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41125__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__41127){
...
var key = first__41130;
var args = seq__41129__$1;
var G__41131 = key;
...
break;
case "ordinal-suffix":
var vec__41132 = syntax_list.call(null,(i - (1)));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41131__$1)].join('')));
...
var d = value;
var G__41139 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__41140 = G__41139;
...
var unparser = first__41142;
var more = seq__41141__$1;
var s = "";
var d__$1 = d;
var G__41139__$1 = G__41139;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__41143 = G__41139__$1;
var seq__41144 = cljs.core.seq.call(null,vec__41143);
var first__41145 = cljs.core.first.call(null,seq__41144);
var seq__41144__$1 = cljs.core.next.call(null,seq__41144);
var unparser__$1 = first__41145;
var more__$1 = seq__41144__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__41146 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__41146,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__41146,(1),null);
var G__41149 = d__$3;
var G__41150 = more__$1;
var G__41151 = s__$3;
d__$1 = G__41149;
G__41139__$1 = G__41150;
s__$1 = G__41151;
continue;
}
break;
...
//# sourceMappingURL=unparse.js.map?rel=1510137277561
