...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30846__auto__,writer__30847__auto__,opt__30848__auto__){
return cljs.core._write.call(null,writer__30847__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__33179 = o;
(G__33179[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__33181__i < G__33181__a.length) {G__33181__a[G__33181__i] = arguments[G__33181__i + 0]; ++G__33181__i;}
  args = new cljs.core.IndexedSeq(G__33181__a,0,null);
} 
...
var args = cljs.core.seq(arglist__33182);
...
if(cljs.core.truth_((function (){var and__30163__auto__ = !((jsprops == null));
if(and__30163__auto__){
var and__30163__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__33185 = jsprops;
(G__33185["defaultValue"] = value);

(G__33185["onChange"] = ((function (G__33185,v,value,on_change){
return (function (p1__33184_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33184_SHARP_);
});})(G__33185,v,value,on_change))
);
...
var vec__33188 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33188,(0),null);
var id = cljs.core.nth.call(null,vec__33188,(1),null);
var class$ = cljs.core.nth.call(null,vec__33188,(2),null);
...
var jsprops = ({"argv": v});
var temp__5294__auto___33192 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5294__auto___33192 == null)){
} else {
var key_33193 = temp__5294__auto___33192;
(jsprops["key"] = key_33193);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__33194 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__33194["name"] = c);
...
var len__31452__auto___33199 = arguments.length;
var i__31453__auto___33200 = (0);
while(true){
if((i__31453__auto___33200 < len__31452__auto___33199)){
args__31459__auto__.push((arguments[i__31453__auto___33200]));

var G__33201 = (i__31453__auto___33200 + (1));
i__31453__auto___33200 = G__33201;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31460__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33197){
var G__33198 = cljs.core.first.call(null,seq33197);
var seq33197__$1 = cljs.core.next.call(null,seq33197);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__33198,seq33197__$1);
});
...
break;
default:
var G__33204 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__33204;
continue;
...
var n__31218__auto___33206 = a.length;
var i_33207 = (0);
while(true){
if((i_33207 < n__31218__auto___33206)){
(a[i_33207] = reagent.impl.template.as_element.call(null,(a[i_33207])));

var G__33208 = (i_33207 + (1));
i_33207 = G__33208;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31218__auto___33209 = a.length;
var i_33210 = (0);
while(true){
if((i_33210 < n__31218__auto___33209)){
var val_33211 = (a[i_33210]);
if((cljs.core.vector_QMARK_.call(null,val_33211)) && ((reagent.impl.template.key_from_vec.call(null,val_33211) == null))){
(o["no-key"] = true);
} else {
}

(a[i_33210] = reagent.impl.template.as_element.call(null,val_33211));

var G__33212 = (i_33210 + (1));
i_33210 = G__33212;
continue;
} else {
}
...
var ctx = ({});
var vec__33213 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__33213,(0),null);
var derefed = cljs.core.nth.call(null,vec__33213,(1),null);
...
var G__33216 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33216) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__33216){
...
//# sourceMappingURL=template.js.map?rel=1510137268616
