    ...
    [:div.row
     ...
     [:div.col-md-2.footer-links
      [:ul.unstyled
       ...
       [:li [linkify "https://s3.eu-central-1.amazonaws.com/ote-assets/Tietosuojaseloste_NAP.pdf" (tr [:common-texts :navigation-privacy-policy]) {:target "_blank"}]]
       [:li
     ...
     [:div.col-md-12 (stylefy/use-style style-base/footer-copyright)
      [linkify "http://creativecommons.org/licenses/by/4.0/"
       [:img (merge (stylefy/use-sub-style style-base/footer-copyright :logo)
                    {:src "/cc.svg"})] {:target "_blank"}]
