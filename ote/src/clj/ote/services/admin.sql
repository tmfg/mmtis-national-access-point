-- name: fetch-service-business-ids
   SELECT c.name as "operator", c."business-id" as "business-id",
          s."contact-phone" as "phone", s."contact-gsm" as "gsm", s."contact-email" as "email", CAST('operator' AS text) as "source"
...
SELECT o."name" as "operator", o."business-id" as "business-id",
       o."phone" as "phone", o."gsm" as "gsm", o."email" as "email", CAST('service' AS text) as "source"
